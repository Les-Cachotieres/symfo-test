...
<form method=\"post\">
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12)) {
            ...
            <h2 class=\"mt-3 ml-2\"><span id=\"welcome\">Bienvenue sur ton espace</span> ";
            // line 14
...
";
            ...
            // line 19
            echo "<h1 class=\" mb-3\">Connexion</h1>
<div class=\"container\">
...
";
    ...
    {
        return array (  141 => 36,  129 => 27,  121 => 22,  116 => 19,  108 => 14,  105 => 13,  103 => 12,  100 => 11,  94 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\" container  mt-4 mb-3\">
            <h2 class=\"mt-3 ml-2\"><span id=\"welcome\">Bienvenue sur ton espace</span> {{ app.user.username }} </h2>
        </div>
...
{% endblock %}
", "security/login.html.twig", "/home/symfo/symfo-test/app/templates/security/login.html.twig");
    }
}
