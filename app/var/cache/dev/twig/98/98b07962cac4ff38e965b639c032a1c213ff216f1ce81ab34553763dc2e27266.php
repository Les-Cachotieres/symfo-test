...
class __TwigTemplate_659dced1b492a1692f5fe1f78a7ee6fa84dcacc95e99bfb7f36c3bfe76769efe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
    <button class=\"btn btn-primary mb-3\">{{ button_label|default('Valider') }}</button>
{{ form_end(form) }}
", "appointment/_form.html.twig", "/home/symfo/symfo-test/app/templates/appointment/_form.html.twig");
    }
}
